...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams FULL JOIN games ON teams.team_id = games.winner_id FULL JOIN games AS g2 ON teams.team_id = g2.opponent_id WHERE games.year = 2014 OR g2.year = 2014 ORDER BY name")"
